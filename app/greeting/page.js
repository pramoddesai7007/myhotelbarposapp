...
const Greetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('http://103.159.85.246:6001/api/greet/greet');
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.patch(
        `http://103.159.85.246:6001/api/greet/greet/${editedGreet.id}`,
  ...
  const createGreet = async () => {
    ...
    try {
      if (!dataAdded) {
        const response = await axios.post('http://103.159.85.246:6001/api/greet/greet', {
          greet: trimmedGreet,
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`http://103.159.85.246:6001/api/greet/greet/${greetId}`, updateGreetData);
