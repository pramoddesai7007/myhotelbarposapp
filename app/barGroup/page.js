...
const BarGroupMenu = () => {
  ...
  const handleAddMenusToCategory = async () => {
    try {
      ...
      const response = await axios.post(
        `http://103.159.85.246:6001/api/liquorBrand/${selectedMainCategory}/assignmenus`,
        {
    ...
    const fetchData = async () => {
      try {
        ...
        const mainCategoriesResponse = await axios.get(
          "http://103.159.85.246:6001/api/liquorCategory/barMenus"
        );
  ...
  const fetchMenusForCategory = async () => {
    try {
      const response = await axios.get(
        `http://103.159.85.246:6001/api/liquorCategory/barMenus/${selectedMainCategory}`
      );
  ...
  const handleDeleteMenus = async () => {
    try {
      ...
      const response = await axios.delete(
        `http://103.159.85.246:6001/api/liquorBrand/${selectedMainCategory}/removemenus`,
        {
