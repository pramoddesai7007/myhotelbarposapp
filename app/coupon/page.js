...
const Coupon = () => {
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "http://103.159.85.246:6001/api/counterHotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `http://103.159.85.246:6001/api/counterHotel/getHotel/${defaultHotelId}`
          );
  ...
  //       `http://103.159.85.246:6001/api/counterHotel/getHotel/661e0d39092937c54273c154`
