...
const BankNameList = () => {
  ...
  useEffect(() => {
    const fetchBankNames = async () => {
      try {
        const response = await axios.get('http://103.159.85.246:6001/api/bankName/bankNames');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(`http://103.159.85.246:6001/api/bankName/bankNames/${selectedBankName._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`http://103.159.85.246:6001/api/bankName/bankNames/${selectedBankName._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://103.159.85.246:6001/api/bankName/bankNames', { bankName: newBankName });
